...
import { useGetMerchantPermissionsQuery } from "@/app/queryHandler/merchants";
...
export default function RoleDetailPage() {
  ...
  const { data: rolePermissionsData, isLoading: loadingRolePermissions } =
    useGetMerchantPermissionsQuery(rawId ?? "");
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <BackButton />
        <h2 className="text-xl font-bold capitalize">Merchants Permissions</h2>
      </div>
