...
export default function UsersPage() {
  ...
  const { data, isLoading } = useGetUsersQuery(userFilters);
  const { mutateAsync: activateUser } = useActivateUserMutation();
  const { mutateAsync: deactivateUser } = useDeactivateUserMutation();
