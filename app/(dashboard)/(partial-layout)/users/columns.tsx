...
/**
 * Generates column definitions for the User table.
 * @param onAction - callback to handle actions
 * @param router - pass router from a component (useRouter)
 */
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-44">
            ...
            <DropdownMenuItem
              onClick={() => router.push(`/users/${user.role.id}/permissions`)}
              className="cursor-pointer"
            >
              View Permissions
            </DropdownMenuItem>
